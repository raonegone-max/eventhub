    ...
    return (
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 md:py-16">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mt-8">
                <div className="p-6 rounded-2xl bg-[#141b2b]/80 border border-white/10">
            ...
            <div className="mt-10">
                ...
                {events.length === 0 ? (
                    <div className="text-center py-16 bg-white/[0.02] border border-white/5 rounded-3xl p-8 max-w-md mx-auto">
                    ...
                    <div className="space-y-4">
                        {events.map((event) => {
                            ...
                            return (
                                <div
                                    key={event._id}
                                    className="p-5 sm:p-6 rounded-2xl bg-[#141b2b]/80 border border-white/10 hover:border-amber-400/30 transition-all flex flex-col md:flex-row md:items-center justify-between gap-4"
                                >
                                    <div className="space-y-1.5 flex-1">
                                        <div className="flex items-center gap-2">
                                            <span className="text-xs font-mono text-amber-400 px-2 py-0.5 rounded-full bg-amber-400/10 border border-amber-400/20">
                                                {dateStr}
                                            </span>
                                            {event.capacity && (
                                        ...
                                        <Link
                                            to={`/events/${event._id}`}
                                            className="text-lg font-bold text-white hover:text-amber-400 transition font-sans inline-block"
                                        >
                                            {event.title}
                                        </Link>
